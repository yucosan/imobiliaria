...
<?php
	...
	if ($result<2)
	echo "Existe ".$result." imovel disponivel para editar";
else
	echo "Existem ".$result." imoveis disponiveis para editar";
									...
									<div class="row equal" style="height: ;">
										...
										<div class="col-12 col-sm-12  col-md-6 col-lg-4">
											<div class="card" style="width: 18rem; margin-top: 3rem;">
											  ...
											  <div class="card-body">
												<a href="editar_imovel?id=<?php echo $id_imovel[$aux2] ?>" class="card-link">Editar</a>
											  </div>
											</div>
									</div>
